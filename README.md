...
*   **Protección de Derechos e Información**: Puesto que las novelas se encuentran en fase de pre-publicación y certámenes literarios (los cuales exigen estricto anonimato y novedad), los textos y detalles de las novelas están elegantemente **difuminados y pixelados** mediante filtros CSS, con tarjetas informativas nítidas superpuestas.
*   **Club de Lectura (Comunidad)**: Formulario de suscripción para que los lectores reciban boletines, anuncios de presentaciones, firmas de libros y fechas oficiales de publicación.
...
*   **Paquete Completo de Favicons**: Icono del sitio personalizado con el logotipo de la mariposa negra sobre un círculo crema sólido, adaptado a todos los formatos estándar (Android, Apple, navegadores modernos y de escritorio).
...
4.  **Scripts de Procesamiento de Imagen (Python / Pillow)**: Scripts auxiliares para automatizar el recorte de transparencias del logotipo y la compilación del set completo de favicons con el círculo de fondo corporativo.
...
├── script.js                   # Interactividad, menú móvil y formulario mailto
